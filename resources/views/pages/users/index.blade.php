                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('users.edit', $user->id ) }}" class="btn btn-sm btn-warning btn-icon mr-2" title="Edit details">
                                        <span class="svg-icon svg-icon-md">
                                    ...
                                    <form class="form__delete" style="display: inline-block;" method="POST" action="{{ route('users.destroy', $user->id ) }}">
                                        @csrf
                                        @method('DELETE')
