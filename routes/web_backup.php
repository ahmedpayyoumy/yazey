...
Route::group([
    ...
    Route::post('/login', 'UserController@postLogin')->name('loginPost');
    ...
    Route::get('/forgot-password', 'UserController@forgotPasswordView')->name('forgot');
    Route::post('/forgot-password', 'UserController@postforgotPassword')->name('forgotPost');

    Route::get('/reset-password/{email}/{token}', 'UserController@resetPasswordView')->name('reset');
    Route::post('/reset-password/{email}/{token}', 'UserController@postResetPassword')->name('resetPost');

    Route::get('/verify/{email}/{token}', 'UserController@verify')->name('verify');

    Route::get('/retype-email', 'UserController@retypeEmailView')->name('retype-email');
